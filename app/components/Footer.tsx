...
export default function Footer() {
  const navigation = {
    main: [
      ...
      { name: 'Jummah', href: '/jummah' },
      { name: 'Ramadhan', href: '/ramadhan' },
    ],
    community: [
      { name: 'Islamic Classes', href: '/classes' },
      { name: 'Youth Activities (Coming Soon)', href: '#' },
      { name: 'Community Support (Coming Soon)', href: '#' },
    ],
    social: [
      ...
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-white">Luton Town Islamic Center</h3>
          ...
          <div className="space-y-4">
            ...
            <p className="text-emerald-200 text-sm">
              Tel: +44 7882 277781 (Brother Nurul Islam)<br />
              Tel: +44 7484 144842 (Brother Abdul Ghani)<br />
              Email: info@lutonislam.com
            </p>
          </div>
        </div>
        ...
        {/* Copyright */}
        <p className="mt-10 text-center text-xs leading-5 text-emerald-300">
          &copy; {new Date().getFullYear()} Luton Town Islamic Center. All rights reserved.
        </p>
      </div>
    </footer>
  );
